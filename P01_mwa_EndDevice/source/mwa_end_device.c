...
static void App_TransmitCounter(uint8_t Ledcounter);
...
{ 
    ...
    uint8_t rc;
    int ledcounter = MyTask2_GetCounter();
    ...
    while(1)
    {
        ...
        case stateScanActiveStart:
            ...
            MyTask2Timer_Stop(); /* STOP Timer from MY NEW TASK*/
                ...
                {   
                    ...
                    {          
                        ...
                        { 
                            ...
                            MyTask2Timer_Start(); /*Start LED flashing with your task*/
                            gState = stateListen;
                            OSA_EventSet(mAppEvent, gAppEvtDummyEvent_c); 
                        }        
                        else 
        ...
        case stateListen:
            ...
            if ( ledcounter != MyTask2_GetCounter()){
                ledcounter = MyTask2_GetCounter();
            	App_TransmitCounter(ledcounter);
            }
